...
<head>
    ...
    <title>Nespresso rw - login</title>
    ...
    <script>
        function check_input() {
            ...
            if (!document.search_form.pass.value) {
                window.alert('전화번호를 입력하세요.');
                document.search_form.hp.focus();
                return false;
                )
            }
            return true;
...
<body>
    ...
    <div class="menu" id="nav-menu">
        ...
        <ul class="main-menu">
            ...
            <li class="main-sub">
                <a href="#" class="menu-title">프로페셔널<i class="xi-plus-thin"></i></a>

                <ul class="sub-menu">
                    <li><a href="#">기업용 커피</a></li>
    ...
    <section class="login">
        ...
        <form action="email_search.php" class="login-form" method="post" name='search_form'>
            <label for="name">이름</label>
            <input type="text" name="name" id="name" required placeholder="이름을 입력하세요">

            <label for="pass">전화번호</label>
            <input type="tel" id="hp" name="hp" required placeholder="전화번호를 입력하세요">

            <button type="submit" onclick='check_input()'>이메일 찾기</button>
        </form>
