...
<body>
    ...
    <section class="login">
        ...
        <form action="pw_search.php" class="login-form" method="post" name='search_form'>
            <label for="name">이메일 주소</label>
            <input type="text" name="email" id="email" required placeholder="이메일을 입력하세요">

            <label for="pass">이름</label>
            <input type="tel" id="name" name="name" required placeholder="이름을 입력하세요">

            <button type="submit" onclick='check_input()'>비밀번호 찾기</button>
        </form>
